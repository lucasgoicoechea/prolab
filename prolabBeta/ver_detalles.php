...
<br>
<center><div class="titulo" style="width:90%;">Detalles de la Oferta</div></center>

<br>
<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center" >
  <tr>
    <td class="descrip" align="left"><span style="font-weight:bold; font-size:14px; color:black;"> <? echo $fila['aviso'];?></span></td>
  </tr>
  <tr><td>&nbsp;</br></br></td></tr>
  <tr> 
...
<?php
	...
	print '<a  style="color:#DD3177;" href="index.php?op=postularse.php&idO='.$_GET["idO"].'"><b>POSTULARSE A ESTA OFERTA</b></a></div></td>';
	print '<td><div align="center" style="font-size:14;">';
