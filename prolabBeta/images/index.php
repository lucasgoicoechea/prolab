...
<div class="fondo">
  ...
  <!--	</div>
		...
		<td align="left" width="95%">
			...
			<tr> <td align="left" >	
                       <img src="./images/parteinferior.jpg" title="" alt="">
					   </td>
		</table>
  </div>
	    ...
	    <!-- LINKS - ENLACES -->
		  ...
		  <div class="">
			<table width="100%" align="center">
				<tr>
				  <td align="center" class="principal" style="border-right-style:solid;"><br><br><br>
		 ...
		 <br><br><br>
		  ...
		  <div class="">
				...
				<table width="100%" align="center">
					...
					<tr><td align="center" style="text-decoration: none;">
						<a  style="text-decoration: none;" href="http://www.empleos.amia.org.ar/dicontenidos.asp?IDSubSeccion=141" target="blank" >
						<img src="img/talleres2.jpg" width="154" height="75" style="text-decoration: none;">
					...
					<td align="center" style="text-decoration: none;">
						...
						<img src="img/unlp.JPG" width="88" height="37" style="text-decoration: none;">
						</a>
					</td>
					</tr>
					<tr><td><hr width="100%">  </td></tr>
