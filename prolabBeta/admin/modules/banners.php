...
if ($row['radminsuper'] == 1) {
	...
	function BannersAdmin() {
		global $prefix, $db, $bgcolor2, $banners, $admin_file;
		include ("header.php");
		GraphicAdmin();
		OpenTable();
	...
	function BannerDelete($bid, $ok=0) {
		...
		."[ <a href=\"".$admin_file.".php?op=BannersAdmin#top\">" . _NO . "</a> | <a href=\"".$admin_file.".php?op=BannerDelete&amp;bid=$bid&amp;ok=1\">" . _YES . "</a> ]</center><br><br>";
		CloseTable();
		include("footer.php");
	}
