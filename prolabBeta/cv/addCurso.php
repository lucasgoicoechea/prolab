...
//-------------------------------------------------------------------------------------------
		...
		$this->addElement('text', 'horas', 'Horas de duración:',array('style' => 'width: 8em;','class' => 'caja'));
...
class ActionProcess extends HTML_QuickForm_Action
{
    function perform(&$page, $actionName)
    {
		...
		$query ="INSERT INTO usuarios_cursos (usuario,curso,institucion,horas, anio) VALUES (";
