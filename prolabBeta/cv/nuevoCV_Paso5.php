...
<center><span class="titulo1">CV FINALIZADO CON EXITO</span></center>
...
?>
  <fieldset style="width: 80%;">
    <legend><span class="titulo1">GRACIAS POR SUSCRIBIRSE A PROLAB SERVICIO DE EMPLEO</span></legend>
     <br> 
    	<table  width="100%">
...
<tr>
	<td align="center" colspan="2"><br>
		<input class="boton" type="button" value="Ver Ofertas" onclick="javascript:window.location='index.php'"/>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		
