...
//	session_start();
	...
	echo "<html><head><title>main</title><link rel='stylesheet' href='estilos/estilos.css' type='text/css'></head><body class='body'>";
	...
	echo ("<a href='#".$row2["idU"]."'>".$row2["idU"]."</a>");
	echo (" - ");
...
//*************************PRESELECCIONADOS****************************
	...
	echo("</A><a href='#".$row2["idUsuario"]."'>".$row2["idUsuario"]." - ".$aux2["apellido"].", ".$aux2["nombre"]."</a>  ");
	echo "<BR>";
	}
...
/********************************/
	...
	echo "<FORM ACTION='viewOfertas.php'><input class='boton' type= 'submit' name='salir' value='Volver' type='button' /></FORM>	</div></body></html>";
?>	