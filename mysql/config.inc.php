<?php
/* $Id: config.inc.php,v 2.18 2004/05/05 10:05:29 nijel Exp $ */
 ...
 */
$cfg['PmaAbsoluteUri'] = 'http://www.prolab.unlp.edu.ar/mysql';
...
$cfg['Servers'][$i]['user']          = 'prolabunlp';      // MySQL user
$cfg['Servers'][$i]['password']      = 'prolabsqlpass';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = 'graduados';          // If set to a db-name, only
...
#$cfg['Servers'][$i]['only_db']         = 'recomendaciones_bak';
...
#$cfg['Servers'][$i]['user']            = 'root';
#$cfg['Servers'][$i]['password']        = '';
#$cfg['Servers'][$i]['only_db']         = 'documentacion';
#$cfg['Servers'][$i]['verbose']         = '';
#$cfg['Servers'][$i]['pmadb']           = ''; // 'phpmyadmin' - see scripts/create_tables.sql
#$cfg['Servers'][$i]['bookmarktable']   = ''; // 'pma_bookmark'
#$cfg['Servers'][$i]['relation']        = ''; // 'pma_relation'
 ...
 */
$cfg['FileRevision'] = '$Revision: 2.18 $';
?>
