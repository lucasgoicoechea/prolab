...
function head() {
	...
	/**/
	// la sig. linea la puso Ariel la agego para probar el MENIU
	echo"<script type=\"text/javascript\" language=\"JavaScript1.2\" src=\"stmenu.js\"></script>";
	// marquesina
...
******************************************************************************/
// BANNER 1
var ancho = 100  // especifica la anchura de la marquesina antes 530
var alto = 70 // especifica la altura de la marquesina (alto de las imágenes)
var velo = 35 // velocidad 
...
function escribe(){
	...
	document.write ('<div id ="fuera" style="position:relative; width:' + ancho + '%; height:' + alto + 'px;overflow:hidden">');
...
function mueve(){
	...
	if(detienee > 0){
		if(detienee == pasos){
			...
			if(detienee > (pasos/2) && atras == false){
				vel +=10
			}
			if(detienee < (pasos/2)){
				vel +=10
...
// BANNER 2
var anchoB = 100  // especifica la anchura de la marquesina antes 530
var altoB = 70 // especifica la altura de la marquesina (alto de las imágenes)
var veloB = 35 // velocidad 
var disB = 4 // cantidad de pixels que desplaza por movimiento

//Array de imagenes a mostrar en la marquesina
var imagenesB = new Array()
imagenesB[0] = new Image()
imagenesB[0].src = "Marquesina/nini.jpg" // ruta o nombre de imagen 
imagenesB[0].a = "" // link de la imagen
imagenesB[0].target = "_blank" // target del link
imagenesB[1] = new Image()
imagenesB[1].src = "Marquesina/autosiglo.jpg"
imagenesB[1].a = ""
imagenesB[1].target = "_blank"
imagenesB[2] = new Image()
imagenesB[2].src = "Marquesina/bytonner.jpg"
imagenesB[2].a = ""
imagenesB[2].target = "_blank"
imagenesB[3] = new Image()
imagenesB[3].src = "Marquesina/eleprint.jpg"
imagenesB[3].a = ""
imagenesB[3].target = "_blank"
imagenesB[4] = new Image()
imagenesB[4].src = "Marquesina/icym.jpg"
imagenesB[4].a = ""
imagenesB[4].target = "_blank"
imagenesB[5] = new Image()
imagenesB[5].src = "Marquesina/carpigiani.jpg"
imagenesB[5].a = ""
imagenesB[5].target = "_blank"
imagenesB[6] = new Image()
imagenesB[6].src = "Marquesina/fecami.jpg"
imagenesB[6].a = ""
imagenesB[6].target = "_blank"
imagenesB[7] = new Image()
imagenesB[7].src = "Marquesina/totalAustral1.jpg"
imagenesB[7].a = ""
imagenesB[7].target = "_blank"
imagenesB[8] = new Image()
imagenesB[8].src = "Marquesina/camuzzi.jpg"
imagenesB[8].a = ""
imagenesB[8].target = "_blank"
imagenesB[9] = new Image()
imagenesB[9].src = "Marquesina/game.jpg"
imagenesB[9].a = ""
imagenesB[9].target = "_blank"
imagenesB[10] = new Image()
imagenesB[10].src = "Marquesina/gestores.jpg"
imagenesB[10].a = ""
imagenesB[10].target = "_blank"
...
document.write ('<div id ="fueraB" style="position:relative; width:' + anchoB + '%; height:' + altoB + 'px;overflow:hidden">');
...
/**/
	...
	echo "<link REL=\"shortcut icon\" HREF=\"images/active.gif\">\n";
	
	echo "<link rel=\"alternate\" type=\"application/rss+xml\" title=\"RSS\" href=\"backend.php\">\n";
	echo "<LINK REL=\"StyleSheet\" HREF=\"themes/$ThemeSel/style/style.css\" TYPE=\"text/css\">\n\n\n";
	
	/*
	* Este link a estilos es a un archivo que se copio en themes/WinterICE/styles/estilo.css
	* para que los use el modulo Add_Empresa en el archivo template addEmpresa.html.
	*/
	echo "<LINK REL=\"StyleSheet\" HREF=\"themes/$ThemeSel/style/estilo.css\" TYPE=\"text/css\">\n\n\n";
