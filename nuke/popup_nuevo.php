...
//impresion de los datos
	while (list($idO,$fecha,$tipoOf,$area,$aviso,$retribucion) = mysql_fetch_array($res)){  $x++;
			$fecha = explode("-", $fecha);
...
?>
  ...
  <td bgcolor = <? if ($x % 2 == 0){echo $c1;}else{echo $c2;}?>><div align="center"><span class="texto1"><? echo "$aviso \n"; ?></span></div>
  </td>
    <?
	}
}else{
