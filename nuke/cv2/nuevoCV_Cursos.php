...
<?php										
		while ($cursos = $result -> fetchRow(DB_FETCHMODE_ASSOC)){		
			...
			print("<td align='center' style='background : #E0E0E0 font-size:12px;'><a href='editCurso.php?idUsuarioCurso=".$cursos['id']."&keepThis=true&TB_iframe=true&height=300&width=600'  class='thickbox'><img src='icons/edit.png' border='0' align='middle' width='16' height='16'  alt='Modificar'></a></td>");  	
			print("<td style=' background :#E0E0E0 font-size:12px;' align='center'><a href='javascript:eliminarCurso(".$cursos['id'].")'><img src='icons/del.png' border='0' align='middle' width='16' height='16' alt='Eliminar'></a></td>");	
			print "</tr>";		
		}	//fin del while
		print("</table>");
	}//fin del if
...
var ok=confirm("¿Realmente desea ELIMINAR este curso?");
	if(ok)
	{
	document.location="deleteCurso.php?id="+idCurso;
	}
}
