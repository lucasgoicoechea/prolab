	...
	if (isset($row)){
			...
			//caso estudiante	
				...
				<SCRIPT type="text/javascript" language="javascript">
					cvwindow=window.open('condicion.html','miVentana','toolbar=0,location=0,directories=0,status=1,menubar=0,scrollbars=yes,resizable=yes,width=700,height=500');
					openerPage2=openerPage.location('modules.php?name=Login_Prolab');
				</SCRIPT>
				<?
