...
if ($row['radminsuper'] == 1) {
	...
	function BlocksAdmin() {
		...
		while ($row = $db->sql_fetchrow($result)) {
			...
			if ($block_act == 0) {
				...
				echo "<img src=\"images/view_x.gif\" alt=\""._SHOW."\" title=\""._SHOW."\" border=\"0\" width=\"17\" height=\"17\"></font>&nbsp;</td></tr>";
			}
		}
		echo "</table>"
		."<br><br>"
	...
	function block_show($bid) {
		...
		."[ <a href=\"".$admin_file.".php?op=ChangeStatus&bid=$bid\">"._ACTIVATE."</a> | <a href=\"".$admin_file.".php?op=BlocksEdit&bid=$bid\">"._EDIT."</a> | ";
		if ($bkey == "") {
