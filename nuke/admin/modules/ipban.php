...
if ($row['radminsuper'] == 1) {
	...
	function main_ban($ip=0) {
		...
		echo "<br><br><b>"._REASON."</b><br><input type='text' name='reason' size='50' maxlength='255'><br><br><input type='hidden' name='op' value='save_banned'><input type='submit' value='Ban this IP'><br><br>"._BANCLASSC."</center>";
		echo "</form>";
		CloseTable();
		...
		if ($numrows != 0) {
			...
			while ($row = $db->sql_fetchrow($result)) {
				...
				."<td bgcolor=\"$bgcolor2\" align='center' nowrap><font class=\"content\">&nbsp;$row[date]&nbsp;</td>"
				."<td bgcolor=\"$bgcolor2\" align='center'><font class=\"content\"><a href=\"".$admin_file.".php?op=ipban_delete&id=$row[id]&ok=0\"><img src=\"images/unban.gif\" width=\"15\" height=\"15\" border=\"0\" alt=\""._UNBAN."\" title=\""._UNBAN."\"></a></td></tr>";
			}
			echo "</table>";
			CloseTable();
		}
