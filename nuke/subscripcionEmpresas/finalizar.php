	...
	if ($_GET['accion'] == 'nueva'){
		...
		$res = mysql_query($sql) or die(mysql_error());
			...
			//dato contacto, telefono, nombre, empresa, email, direccion, empresa
				...
				mail($to_email,$motivo,$cuerpo,$headers);
				$to_email="prolab@presi.unlp.edu.ar"; 		//prolab
				mail($to_email,$motivo,$cuerpo,$headers);
...
<div align="center"><input type="button" value="Salir" class="boton" onclick="javascript:window.location='/html/index.php'"/></div>
