...
<font class=tiny>
Posted by <b><?php formatAidHeader($aid); echo "$aid"; ?></b> on <?php echo"$time $timezone"; ?><br>(<?php echo $counter; ?> reads)
</font><br><br>
<font class=content>
...
<a href="modules.php?name=News&amp;new_topic=<?php echo"$topic"; ?>&author="><img src=<?php echo"$t_image"; ?> border=0 Alt=<?php echo"\"$topictext\""; ?> align=right hspace=10 vspace=10></a>
<font class=option>
Posted by <?php formatAidHeader($aid); ?> on <?php echo"$time $timezone"; ?><br>(<?php echo $counter; ?> reads)
<br><br>
</font>
<font class=content>
