<table class="tblBorder" cellpadding="5" cellspacing="0" width="100%">
	<tr>
		<td align="center"><img src="themes/WinterICE/forums/images/smlArrow.gif" border="0" /> <a class="cattitle" href="{U_VIEW_FORUM}">{FORUM_NAME}</a> <img src="themes/WinterICE/forums/images/smlArrow.gif" border="0" /></td>
	</tr>
</table>
<form method="post" action="{S_POST_DAYS_ACTION}">
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr> 
	  ...
	  <span class="gensmall"><b>{L_MODERATOR}: {MODERATORS}<br /><br />{LOGGED_IN_USER_LIST}</b></span></td>
