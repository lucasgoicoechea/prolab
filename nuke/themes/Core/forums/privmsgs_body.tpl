		  ...
		  <td colspan="3" width="100%" class="row2">
			...
			<table cellspacing="0" cellpadding="1" border="0">
			  ...
			  <tr> 
				...
				<td bgcolor="{T_TD_COLOR2}"><img src="themes/Core/forums/images/spacer.gif" width="{INBOX_LIMIT_IMG_WIDTH}" height="8" aForums-left="{INBOX_LIMIT_PERCENT}" /></td>
...
<form method="post" name="privmsg_list" action="{S_PRIVMSGS_ACTION}">
  ...
  <table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
	  ...
	  <td class="{listrow.ROW_CLASS}" width="5%" align="center" valign="middle"><img src="{listrow.PRIVMSG_FOLDER_IMG}"  aForums-left="{listrow.L_PRIVMSG_FOLDER_AForums-left}" title="{listrow.L_PRIVMSG_FOLDER_AForums-left}" /></td>
