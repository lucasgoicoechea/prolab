...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
  ...
  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  ...
	  <td class="row1" align="center" valign="middle"><img src="{topicrow.TOPIC_FOLDER_IMG}" width="19" height="18" aForums-left="{topicrow.L_TOPIC_FOLDER_AForums-left}" title="{topicrow.L_TOPIC_FOLDER_AForums-left}" /></td>
