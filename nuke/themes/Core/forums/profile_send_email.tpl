...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
		...
		<td class="row2"><span class="gen"><textarea name="message" rows="25" cols="40" wrap="viForums-rightual" style="width:500px" tabindex="3" class="post">{MESSAGE}</textarea></span></td>
