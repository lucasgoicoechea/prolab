...
function bbstyle(bbnumber) {
	...
	if (bbnumber == -1) { // Close all open tags & XPSilver button names
		while (bbcode[0]) {
	...
	if (donotinsert) {		// Close all open tags up to the one just clicked & XPSilver button names
		while (bbcode[bblast]) {
				butnumber = arraypop(bbcode) - 1;
				document.post.message.value += bbtags[butnumber + 1];
				buttext = eval('document.post.addbbcode' + butnumber + '.value');
...
<table border="0" cellspacing="0" cellpadding="0" align="center" width="100%">
  <tr>
	...
	<td background="themes/XPSilver/forums/images/up2.gif" align="center" width="100%" height="25">&nbsp;</td>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
	<tr>
		...
		<td class="row1" background="themes/XPSilver/forums/images/up2.gif" align="center" width="100%" height="25"><span class="topframe">{L_POST_A}</span></td>
	...
	<tr>
		...
		<td class="row1"><span class="genmed"><input type="text" class="post" tabindex="1" name="username" size="25" maxlength="25" value="{USERNAME}" /></span></td>
	</tr>
	...
	<!-- END switch_privmsg -->
	<tr>
	  <td class="row1" width="20%" align="right"><span class="gen"><b>{L_SUBJECT}</b></span></td>
	  <td class="row1" width="80%"> <span class="gen">
	...
	<tr>
	  <td class="row1" valign="top">
		<table width="100%" border="0" cellspacing="0" cellpadding="1">
		  <tr>
			<td align="right"><span class="gen"><b>{L_MESSAGE_BODY}</b></span> </td>
		  </tr>
		  <tr>
	...
	<tr>
	  <td class="row1" valign="middle" align="center"><span class="gen"><b>{L_OPTIONS}</b></span><br /><span class="gensmall">{HTML_STATUS}<br />{BBCODE_STATUS}<br />{SMILIES_STATUS}</span></td>
	  <td class="row1"><span class="gen"> </span>
		<table cellspacing="0" cellpadding="1" border="0">
		  ...
		  <tr>
		  	  <td colspan="2" align="center" height="28" class="row1"> {S_HIDDEN_FORM_FIELDS}<input type="submit" tabindex="5" name="preview" class="mainoption" value="{L_PREVIEW}" />&nbsp;<input type="submit" accesskey="s" tabindex="6" name="post" class="mainoption" value="{L_SUBMIT}" /></td>
		  </tr>
		</table>
	  </td>
	</tr>
