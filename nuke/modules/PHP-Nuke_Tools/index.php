...
include("header.php");
    ...
    OpenTable();
echo "<center><img src=\"modules/PHP-Nuke_Tools/images/tools.gif\"><br><h4></h4>";
    CloseTable();
echo " <CENTER><TABLE height=\"212\" cellSpacing=0 cellPadding=0 width=\"100%\" border=1 style=\"border-collapse: collapse\" bordercolor=\"#111111\" id=\"AutoNumber1\" bordercolorlight=\"#FFFFFF\" bordercolordark=\"#C0C0C0\">"
  . "  <TBODY>"
  . "  "
...
echo "<center><BR><br><h4>"._HELP."</h4><BR><h5>"._MODULEC."</h5>"
  ...
  . "                                    <br>"
  . "                                    &lt;?php <br>"
  . "                                    #### Generated by Module Creator - By "
  . "                                    Disipal site (www.disipal.net) #### <br>"
...
echo "<center><BR><br><h4>"._HELP."</h4><BR><h5>"._BLOCKC."</h5>"
  ...
  . "                                    <br>"
  . "                                    &lt;?php<br>"
  . "                                    #### Generated by Block Creator by Disipal "
  . "                                    Site (www.disipal.net) ###<br>"
  . "                                    if "
  . "                                    (eregi(&quot;block-Block_Creator.php&quot;,$ PHP_SELF)) "
  . "                                    {<br>"
  ...
  . "                                    <td>"
  . "                                    <br>"
  . "                                    if (eregi(&quot;block-whatever.php&quot;,$ PHP_SELF)) {<br>"
  . "                                    &nbsp;</td>"
  . "                                  </tr>"
  . "                                </table>"
  . "                                <p> <br>"
  ...
  . "&nbsp;</font></td>"
  . "                              </tr>"
  . "                            </table><BR><BR><CENTER>&nbsp;&nbsp;[&nbsp;&nbsp;<a href=\"modules.php?name=PHP-Nuke_Tools&file=index&func=Block\">Back to Block Creator</a>&nbsp;&nbsp;]&nbsp;&nbsp";
    CloseTable();
    OpenTable();
   echo"    <CENTER>&nbsp;&nbsp;[&nbsp;&nbsp;<a href=\"modules.php?name=$module_name\">"._BACK."</a>&nbsp;&nbsp;]&nbsp;&nbsp";
    CloseTable();
...
echo " <TABLE  cellSpacing=0 cellPadding=0 width=\"100%\" border=0>"
  ...
  . "          <p>"._HTMLEP."</TD></TR></TBODY></TABLE></FORM>"
  . "</TD></TR></TBODY></TABLE>"
  . "</TD></TR></TBODY></TABLE>";
    CloseTable();
