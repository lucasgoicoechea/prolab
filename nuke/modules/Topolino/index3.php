...
//Formulario
		...
		//$this -> $action = $_SERVER['PHP_SELF'].'?name=Topolino';
...
class ActionProcess extends HTML_QuickForm_Action
{
	...
	$fecha = date("Y-m-d");
/*
	$query ="INSERT INTO empresas (fecha_ingreso,nombre,apellido,sexo,email,telefono,puesto,razonsocial,nombrecomercial,industria,pais,provincia,ciudad,calle,numero,piso,cp,cuit,iva,emaile,telefonoe,faxe,web,descripcion,empleados) VALUES (";
	$query .="'".$fecha."',";
	$query .="'".$values["nombre"]."',";
...
//$wizard->addPage(new Page_addGraduado('page1','POST','_SELF',array('action' => 'modules.php?name=Topolino?name=Topolino')));
//$wizard->addPage(new Page_addGraduado('page1','POST','_SELF',array('action' => $_SERVER['PHP_SELF'].'?name=Topolino')));
$wizard->addPage(new Page_addGraduado('page1',$_SERVER['PHP_SELF'].'?name=Topolino'));
