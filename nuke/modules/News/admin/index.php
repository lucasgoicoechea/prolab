...
if ($row2['radminsuper'] == 1 || $auth_user == 1) {
	...
	function displayStory($qid) {
		...
		echo "<br><br><b>"._STORYTEXT."</b><br>"
		."<textarea wrap=\"virtual\" cols=\"100\" rows=\"15\" name=\"hometext\">$story</textarea><br><br>"
		."<b>"._EXTENDEDTEXT."</b><br>"
		."<textarea wrap=\"virtual\" cols=\"100\" rows=\"15\" name=\"bodytext\">$storyext</textarea><BR>"
		."<font class=\"content\">"._AREYOUSURE."</font><br><br>"
		."<b>"._NOTES."</b><br>"
		."<textarea wrap=\"virtual\" cols=\"100\" rows=\"10\" name=\"notes\"></textarea><br>"
	...
	function adminStory() {
		...
		echo "<br><br><b>"._STORYTEXT."</b><br>"
		."<textarea wrap=\"virtual\" cols=\"100\" rows=\"15\" name=\"hometext\"></textarea><br><br>"
		."<b>"._EXTENDEDTEXT."</b><br>"
		."<textarea wrap=\"virtual\" cols=\"100\" rows=\"15\" name=\"bodytext\"></textarea><br>"
	...
	function previewAdminStory($automated, $year, $day, $month, $hour, $min, $subject, $hometext, $bodytext, $topic, $catid, $ihome, $alanguage, $acomm, $pollTitle, $optionText, $assotop) {
		...
		."<textarea wrap=\"virtual\" cols=\"100\" rows=\"15\" name=\"hometext\">$hometext</textarea><br><br>"
		."<b>"._EXTENDEDTEXT."</b><br>"
		."<textarea wrap=\"virtual\" cols=\"100\" rows=\"15\" name=\"bodytext\">$bodytext</textarea><br><br>";
		if ($automated == 1) {
			$sel1 = "checked";
			$sel2 = "";
		} else {
