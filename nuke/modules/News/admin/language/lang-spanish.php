...
define("_PUBLISHINHOME","¿Publicar en la Página de Inicio?");
...
define("_REMOVESTORY","¿Estás seguro de que deseas borrar la Noticia ID #");
...
define("_ATTACHAPOLL","Anexar una Encuesta a este Artículo");
define("_LEAVEBLANKTONOTATTACH","(Deja en blanco para publicar el artículo sin encuesta)<br>(NOTA: Las noticias programadas no pueden tener encuestas anexas)");
