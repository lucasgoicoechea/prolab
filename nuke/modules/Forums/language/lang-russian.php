...
define("_FCOULDNOT","Problems were incountered accessing the Database");
...
define("_FNOTIFY","Notify me by E-mail when there is a new post.(Only for registerd users)");
...
define("_CIAO","Hello");
define("_NOTIFM1","You have recieved this E-mail because someone has posted a reply to your message you posted on $sitename, and you chose");
define("_NOTIFM2"," to be informed by E-mail when this happened.\r\n\r\nYou can see the discussion here: ");
...
define("_WADELCAT","WARNING: You are about to delete a Category and all it's Forums and Messages, would you like to continue?");
define("_WADELFO","WARNING: You are about to delete a Forum and all it's messages, would you like to continue?");
...
define("_FNOTMAIL","Notify E-mail");
define("_FINDNOT","Notifyca Adress");
...
define("_FORUMMENU","Forum Administration Men›");
...
define("_FORUMATCHMMODEINFO","To attach a file to your message, follow the two steps mentioned, repating them if necessary to include more than a file.<br>At the end, click on<B>OK</B> to go back to your massage.");
define("_FORUMATCHMMODEINFO1","Click on<B>Browse</B> to select the file<br> or type the path in the following field.");
...
define("_NONE","None");
define("_RANKIMB","(N.B. Images must be in the directory:  <b>images/forum/special/</b>)");
...
define("_FMPIUL","More readed messages");
...
define("_FHACK","<font color=\"#FF0000\"> *** INSERT CODE PROHIBITED - THIS MESSAGE IS A PROBABLE ATTEMPT TO ATTACK FROM AN HACKER! IP ADDRESS REGISTERED! *** </font>");
...
define("_HSH5","These are more readed ten messages. Near , between brackets, you can see how many times messages are readed.");
