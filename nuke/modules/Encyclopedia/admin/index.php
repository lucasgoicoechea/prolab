...
if ($row2['radminsuper'] == 1 || $auth_user == 1) {
	...
	function encyclopedia() {
		...
		while($ency = $db->sql_fetchrow($result)) {
			...
			echo "<tr><td width=\"100%\">&nbsp;<a href=\"modules.php?name=Encyclopedia&op=list_content&eid=$ency[eid]\">$ency[title]</a></td><td align=\"center\">$num</td><td align=\"center\">$status</td><td align=\"center\" nowrap>&nbsp;<a href=\"".$admin_file.".php?op=encyclopedia_edit&eid=$ency[eid]\"><img src=\"images/edit.gif\" alt=\""._EDIT."\" title=\""._EDIT."\" border=\"0\" width=\"17\" height=\"17\"></a>  <a href=\"".$admin_file.".php?op=encyclopedia_change_status&eid=$ency[eid]&active=$active\">$status_chng</a>  <a href=\"".$admin_file.".php?op=encyclopedia_delete&eid=$ency[eid]\"><img src=\"images/delete.gif\" alt=\""._DELETE."\" title=\""._DELETE."\" border=\"0\" width=\"17\" height=\"17\"></a>&nbsp;</td></tr>";
		}
		echo "</table>";
		CloseTable();
		echo "<br>";
