...
//-------------------------------------------------------------------------------------------
		...
		$this->addElement('header', 'subtitulo', 'Modifica los datos sobre estudios');
		...
		$this->addElement('date', 'egreso', 'Año de egreso:', array('format'=>'Y', 'minYear'=>date("Y"), 'maxYear'=>1980,'language'=>'es'),array('class'=>'select'));
...
//reglas de validación
	...
	$this->addRule('institucion', 'Tenes que ingresar al institución', 'required');
...
class ActionProcess extends HTML_QuickForm_Action
{
    function perform(&$page, $actionName)
    {
		...
		$query .="titulo='".$values["recibidoDe"]."',";
