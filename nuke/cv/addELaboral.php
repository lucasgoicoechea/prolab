...
class ActionProcess extends HTML_QuickForm_Action
{
    function perform(&$page, $actionName)
    {
		...
		$query ="INSERT INTO usuarios_experiencia (usuario,tipo,empresa,localidad,area,rubro,puesto,responsabilidades,mes_ingreso,ano_ingreso,mes_egreso,ano_egreso,motivo,pers_cargo,observaciones,remuneracion) VALUES (";
		...
		$query .="'".$values["rubro"]."',";
		$query .="'".$values["puesto"]."',";
		$query .="'".$values["responsabilidades"]."',";
		...
		$page->removeElement('subtitulo');
		$page->addElement('submit',$page->getButtonName('modificar'),'Agregar otra',array('class' => 'botonG'));
