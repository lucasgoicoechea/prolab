...
class Page_addInformatica extends HTML_QuickForm_Page
{
	function buildForm(){
...
//Acceso a la base de datos
	...
	$query ="Select * FROM usuarios_informatica WHERE ";
	$query .="id='".$_GET["id"]."'";
...
//-------------------------------------------------------------------------------------------
		$this->addElement('header', 'titulo', 'Conocimientos informáticos');
		$this->addElement('header', 'subtitulo', 'Ingresá la herramienta o tema y tu nivel de dominio');
		
		
		$this->addElement('hidden', 'usuario');

		$this->addElement('text', 'conocimiento', 'Herramienta o tema:',array('style' => 'width: 15em;','class' => 'caja'));
...
//reglas de validación
		$this->addRule('conocimiento', 'Tenes que ingresar una herramienta o tema', 'required');
...
class ActionProcess extends HTML_QuickForm_Action
{
    function perform(&$page, $actionName)
    {
		...
		$query = "UPDATE usuarios_informatica SET ";
		$query .="conocimiento='".$values["conocimiento"]."',";
...
class ActionDisplay extends HTML_QuickForm_Action_Display
{
    function _renderForm(&$page)
    {
		...
		$tpl->loadTemplateFile('addInformatica.html');
...
$wizard =& new HTML_QuickForm_Controller('addInformatica', true);

$wizard->addPage(new Page_addInformatica('page1'));
