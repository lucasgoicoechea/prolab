...
class ActionProcess extends HTML_QuickForm_Action
{
    function perform(&$page, $actionName)
    {
		...
		$query ="INSERT INTO usuarios_idiomas (usuario,idioma,nivel) VALUES (";
		...
		$page->addElement('submit',$page->getButtonName('modificar'),'Agregar otro idioma',array('class' => 'botonG'));
